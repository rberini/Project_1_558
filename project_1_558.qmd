...
The API starts by creating blank variables so that a clean slate is ran each time. Then, valid variables of each possible user selection (numerical, categorical, date, and geographical level) are listed
